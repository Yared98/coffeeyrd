  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
        <span>{t('footer.developed_by', 'Desenvolvido por')}</span>
        <a
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          title={t('footer.website_title', 'Visite o site do desenvolvedor (yared.com.br)')}
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: '0.35rem',
        ...
        <a
          href="https://github.com/Yared98/coffeeyrd"
          target="_blank"
          rel="noopener noreferrer"
          title={t('footer.github_title', 'Ver código-fonte do CoffeeYrd no GitHub')}
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: '0.35rem',
